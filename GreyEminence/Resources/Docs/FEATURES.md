...
- **Why Grey Conseil:** *éminence grise* (Matt’s Grey Eminence) plus Verne’s Conseil. Help → Why Grey Conseil. Links in **Help → Why Grey Conseil**.
...
We **ported** his 0.29.1–0.30.1 behavior (no beachball, cancelled calendar, live screenshots, formatted Copy, open-questions callout). We did **not** merge `main`. Full map: GitHub docs/ORIGIN.md.

## For Matt (if he asks)

This repo is current (**0.28.4-ftl35**). Ask him if he wants **small PRs**, not `feature/speaker-session-rename` as-is. Draft: GitHub docs/MATT-PULL-NOTES.md.
